export const APP_NAME: string = `Nigerian Association of Exploration Geophysicists(NAEG) Mock CBT`;
...
export const DESCRIPTIONS: string = `Mock Examination Portal created by Nigerian Association of Exploration Geophysicists(NAEG)`;
